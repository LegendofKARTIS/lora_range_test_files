...
unsigned long beaconInterval=2000;   // ESP32-C6
...
<div class=header>
  <div class=title>LORA on ESP32C6</div>
  <div class=status>
...
void setup(){
 ...
 Serial.begin(115200);
for(int i=0;i<HISTORY;i++){
  rssiHist[i]=-120;   // bottom of graph
  snrHist[i]=0;
}



 LoRa.begin(115200, SERIAL_8N1, 4, 5);   // RX, TX
